...
export interface AllowlistRule {
  type: 'exact_domain' | 'exact_email' | 'wildcard_subdomain' | string;
  value: string;
}
...
export function isEmailAllowed(
  email: string,
  list: AllowlistRule[] = ALLOWLIST,
  extraEmails: string[] | string | null = null
): boolean {
  ...
  const allowedExtra: string[] = extraEmails !== null
